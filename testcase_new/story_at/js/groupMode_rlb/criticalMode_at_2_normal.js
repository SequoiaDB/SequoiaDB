 ...
 * @ATCaseID: criticalMode_at_2_normal
 * @Author: Chengxi Liao
...
function test() {
  ...
  setLocationForNodes(rg, slaveNodelList.slice(0, 2), location1);
  setLocationForNodes(rg, slaveNodelList.slice(2, 4), location2);
