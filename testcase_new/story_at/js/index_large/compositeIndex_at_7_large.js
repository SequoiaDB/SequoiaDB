 ...
 *
 **************************************************************************************************/
testConf.clName = COMMCLNAME + "_compositeIndex_at_7";
...
function test(testPara)
{
   ...
   db.analyze({Collection: testConf.csName + "." + testConf.clName, SampleNum:100,Mode:2 } );
   ...
   while ( statACCur.next() )
   {
      ...
      var indexName = cl.find({a:statRecord["Key"]}).sort({c:-1}).explain().current().toObj()["IndexName"];
