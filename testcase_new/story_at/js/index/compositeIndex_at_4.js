 ...
 * 测试步骤：
 *    1.创建集合
 *    2.在集合上创建字段a,b,c,d,e,f,g的复合索引，字段a,b,c,d,e,h的复合索引
 *    3.写入一定量数据
 *    4.执行查询，查询条件覆盖a,b,c,d,e,f,g
 *
 * 期望结果：
 *    访问计划选择的索引为字段a,b,c,d,e,f,g的复合索引
 *
 **************************************************************************************************/
testConf.clName = COMMCLNAME + "_compositeIndex_at_4";
...
function test(testPara)
{
   ...
   cl.createIndex("abcdeh",{"a":1,"b":1,"c":1,"d":1,"e":1,"h":1});
   ...
   assert.equal( indexName, "abcdefg" );
   ...
   var query4 = getOneSample( dbNode, testConf.csName, testConf.clName, "abcdefg" );
