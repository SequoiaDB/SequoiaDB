/**************************************************************************
 * @Description:   seqDB-13415: lock加锁写lob
 * @Modify:        Suqiang Ling
 *                 2017-11-17
 **************************************************************************/
...
class lobLockAndWrite13415 : public testBase
{
protected:
   const CHAR *pCsName ;
   const CHAR *pClName ;
   ...
   void SetUp()
   {
      ...
      INT32 rc = SDB_OK ;
      pCsName = "lobLockAndWrite13415" ;
      pClName = "lobLockAndWrite13415" ;
...
TEST_F( lobLockAndWrite13415, lobWrite )
{
   INT32 rc                = SDB_OK ;
   sdbLob lob ;
   OID oid ;
