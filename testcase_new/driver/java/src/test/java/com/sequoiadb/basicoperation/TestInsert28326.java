...
/**
 * @Descreption seqDB-28326:分区表指定分区键包含oid，插入数据不带OID且不包含分区键字段，执行切分
 * @author wuyan
 * @Date 2022.10.19
 * @version 1.00
 */
public class TestInsert28326 extends SdbTestBase {
    private Sequoiadb sdb = null;
    private CollectionSpace cs;
    private String csName = "insertcs28326";
    private String clNameBase = "insert28326";
    ...
    public void test( int clNo, BasicBSONObject keyValue ) {
        ...
        // coord查询数据值正确
        DBCursor queryCursor = cl.query( null, null, "{testa:1}", null );
