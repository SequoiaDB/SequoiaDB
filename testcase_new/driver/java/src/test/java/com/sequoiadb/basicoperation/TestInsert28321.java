...
/**
 * @Descreption seqDB-28321:分区表指定分区键包含oid，不带OID单插入数据后执行切分
 * @author wuyan
 * @Date 2022.10.19
 * @version 1.00
 */
public class TestInsert28321 extends SdbTestBase {
    private Sequoiadb sdb = null;
    private CollectionSpace cs;
    private String csName = "cs28321";
    private String clNameBase = "insert28321";
    ...
    public void test( int clNo, BasicBSONObject keyValue ) {
        ...
        Node destMaterNodeInfo = sdb.getReplicaGroup( destGroupName )
                .getMaster();
        long srcCount = Commlib.checkRecordNumOnData( csName,clName, srcMaterNodeInfo,
                recordNum );
        long destCount = Commlib.checkRecordNumOnData( csName,clName, destMaterNodeInfo,
                recordNum );
