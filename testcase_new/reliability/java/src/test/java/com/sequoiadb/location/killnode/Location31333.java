...
/**
 * @Description seqDB-31333:集合设置ReplSize为2，位置多数派优先，插入数据过程中亲和性Location异常中一个节点异常
 * @Author TangTao
 * @Date 2023.05.04
...
public class Location31333 extends SdbTestBase {

    private Sequoiadb sdb = null;
    private GroupMgr groupMgr;
    private DBCollection dbcl = null;
    private String csName = "cs_31333";
    private String clName = "cl_31333";
    private String primaryLocation = "guangzhou.nansha_31333";
    private String sameCityLocation = "guangzhou.panyu_31333";
    private String offsiteLocation = "shenzhen.nanshan_31333";
