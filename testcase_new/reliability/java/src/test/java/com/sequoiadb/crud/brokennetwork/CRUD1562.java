...
/**
 * @Description seqDB-1562:数据操作过程中coord所在主机断网
 * @author zhangyanan
 * @Date 2021.07.15
 * @version 2.10
 */
public class CRUD1562 extends SdbTestBase {
    private Sequoiadb sdb = null;
    private Sequoiadb sdb1 = null;
    private CollectionSpace cs = null;
    private String clName = "curdcl_1562";
    ...
    private String brokenNetCoordUrl = null;
    ...
    public void setup() throws ReliabilityException {
        ...
        brokenNetCoordUrl = TransUtil.getCoordUrl( sdb );
        sdb1 = new Sequoiadb( brokenNetCoordUrl, "", "" );
    ...
    public void test() throws Exception {
        ...
        FaultMakeTask faultTask = BrokenNetwork
                .getFaultMakeTask( nodeWrapper.hostName(), 0, 20 );
    ...
    private void expectedData( int updateBeginNo, int deleteBeginNo ) {
        ...
        if ( insertSuccessNo != 4000 ) {
            ...
            if ( cl.getCount( obj2.toString() ) == 1 ) {
                ...
                cursor.close();
                BSONObject obj = new BasicBSONObject();
                obj.put( "testa", insertSuccessNo2 );
                obj.put( "no", insertSuccessNo2 );
                obj.put( "num", insertSuccessNo2 );
                obj.put( "_id", oid );
    ...
    private class threadInsert extends OperateTask {
        ...
        public void exec() throws Exception {
            try ( Sequoiadb db = new Sequoiadb( brokenNetCoordUrl, "", "" ) ;) {
