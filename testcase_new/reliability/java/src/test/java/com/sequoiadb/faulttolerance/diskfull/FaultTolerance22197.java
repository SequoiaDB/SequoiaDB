...
/**
 * @Description seqDB-22197: 容错级别为半容错，1个副本状态为:NOSPC或者DEADSYNC，不同replSize的集合中插入数据
 * @Author Zhao Xiaoni
 * @Date 2020-6-4
 * @UpdatreAuthor liuli
 * @UpdateDate 2020-12-19
 */
public class FaultTolerance22197 extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String csName = "cs_22197";
    private String clName = "cl_22197";
