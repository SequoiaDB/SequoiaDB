...
/**
 * @Description seqDB-1566:整个数据组进程正常退出
 * @author zhangyanan
 * @Date 2021.07.15
 * @version 2.10
 */
public class CRUD1566 extends SdbTestBase {
    private Sequoiadb sdb = null;
    private CollectionSpace cs = null;
    private String clName = "curdcl_1566";
    ...
    public void test() throws Exception {
        ...
        restartNode restart = new restartNode();
        mgr.addTask( restart );
            ...
            try ( Sequoiadb db = new Sequoiadb( SdbTestBase.coordUrl, "",
                ...
                if ( e.getErrorCode() != SDBError.SDB_CLS_NOT_PRIMARY
                        ...
                        && e.getErrorCode() != SDBError.SDB_NET_CANNOT_CONNECT
                                .getErrorCode()
                        && e.getErrorCode() != SDBError.SDB_DATABASE_DOWN
                                .getErrorCode()
    ...
    private class restartNode extends OperateTask {

        @Override
        public void exec() throws Exception {
            sdb.getReplicaGroup( clGroupName ).stop();
            sdb.getReplicaGroup( clGroupName ).start();
        }
    }
}
