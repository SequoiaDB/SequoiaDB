...
/**
 * @Description seqDB-1544:主节点进程正常退出
 * @author zhangyanan
 * @Date 2021.07.15
 * @version 2.10
 */
public class CRUD1544 extends SdbTestBase {
    private Sequoiadb sdb = null;
    private CollectionSpace cs = null;
    private String clName = "curdcl_1544";
    ...
    public void test() throws Exception {
        ...
        FaultMakeTask faultTask = NodeRestart.getFaultMakeTask( priNode, 0, 5 );
