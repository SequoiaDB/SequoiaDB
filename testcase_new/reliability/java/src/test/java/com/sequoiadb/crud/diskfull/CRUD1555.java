package com.sequoiadb.crud.diskfull;
...
/**
 * @Description seqDB-1555:并发插入数据过程中备节点磁盘满盘
 * @author zhangyanan
 * @Date 2021.07.15
 * @version 2.10
 */
public class CRUD1555 extends SdbTestBase {
    private Sequoiadb sdb = null;
    private CollectionSpace cs = null;
    private String clName = "curdcl_1555";
    ...
    public void setup() throws ReliabilityException {
        ...
        if ( !groupMgr.checkBusinessWithLSNAndDisk( 600 ) ) {
    ...
    public void test() throws Exception {
        ...
        FaultMakeTask faultTask = DiskFull.getFaultMakeTask( priNode.hostName(),
                SdbTestBase.reservedDir, 0, 6 );
        ...
        Assert.assertEquals( groupMgr.checkBusinessWithLSNAndDisk( 600 ),
                true );
