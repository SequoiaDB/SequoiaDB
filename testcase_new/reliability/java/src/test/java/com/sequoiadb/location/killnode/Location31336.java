...
/**
 * @Description seqDB-31336:集合设置ReplSize为3，位置多数派优先，插入数据过程中亲和性Location异常
 * @Author TangTao
 * @Date 2023.05.04
...
public class Location31336 extends SdbTestBase {

    private Sequoiadb sdb = null;
    private GroupMgr groupMgr;
    private DBCollection dbcl = null;
    private String csName = "cs_31336";
    private String clName = "cl_31336";
    private String primaryLocation = "guangzhou.nansha_31336";
    private String sameCityLocation = "guangzhou.panyu_31336";
    private String offsiteLocation = "shenzhen.nanshan_31336";
    ...
    public void test() throws Exception {
        ...
        for ( BasicBSONObject sameCityLocationNode : sameCityLocationNodes ) {
            FaultMakeTask faultTask = KillNode.getFaultMakeTask(
                    ...
                    sameCityLocationNode.getString( "svcName" ), 2 );
            mgr.addTask( faultTask );
        }
        mgr.addTask( new Insert( clName, primaryLocationSlaveNodes,
                otherLocationNodes ) );
        mgr.execute();
        ...
        int finalNum = recordNum * 2;
        // 校验数据已经同步到具有亲和性的Location
        LocationUtils.checkRecordSync( csName, clName, finalNum,
    ...
    private class Insert extends OperateTask {
        ...
        private Insert( String name, ArrayList< BasicBSONObject > primary,
