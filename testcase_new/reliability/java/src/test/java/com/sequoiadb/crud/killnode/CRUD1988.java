...
/**
 * @Description seqDB-1988:协调节点进程异常退出
 * @author zhangyanan
 * @Date 2021.07.15
 * @version 2.10
 */
public class CRUD1988 extends SdbTestBase {
    private Sequoiadb sdb = null;
    private Sequoiadb sdb1 = null;
    private CollectionSpace cs = null;
    private String clName = "curdcl_1988";
    private DBCollection cl = null;
    private GroupMgr groupMgr = null;
    private static ArrayList< BSONObject > allRecords = new ArrayList< BSONObject >();
    private static ArrayList< BSONObject > insertRecords1 = new ArrayList< BSONObject >();
    private static ArrayList< BSONObject > insertRecords2 = new ArrayList< BSONObject >();
    private static ArrayList< BSONObject > insertRecords3 = new ArrayList< BSONObject >();
    ...
    public void test() throws Exception {
        ...
        FaultMakeTask faultTask = KillNode.getFaultMakeTask(
                nodeWrapper.hostName(), nodeWrapper.svcName(), 2 );
