...
/**
 * @Description seqDB-31339:集合设置ReplSize为3，主位置多数派优先，插入数据过程中PrimaryLocation中一个备节点异常
 * @Author TangTao
 * @Date 2023.05.04
...
public class Location31339 extends SdbTestBase {

    private Sequoiadb sdb = null;
    private GroupMgr groupMgr;
    private DBCollection dbcl = null;
    private String csName = "cs_31339";
    private String clName = "cl_31339";
    private String primaryLocation = "guangzhou.nansha_31339";
    private String sameCityLocation = "guangzhou.panyu_31339";
    private String offsiteLocation = "shenzhen.nanshan_31339";
