...
/**
 * @Description seqDB-31323:容错级别为半容错，同步策略为位置多数派优先，优先同步节点状态为NOSPC或DEADSYNC
 * @Author TangTao
 * @Date 2023.05.05
 ...
 * @version 1.0
 */
public class Location31323 extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String csName = "cs_31323";
    private String clName = "cl_31323";
    private String testClName = "cl_test_31323";
    private String primaryLocation = "guangzhou.nansha_31323";
    private String secondaryLocation = "guangzhou.panyu_31323";
    ...
    public void setUp() throws ReliabilityException {
        ...
        cs.createCollection( clName, new BasicBSONObject( "Group", groupName )
                .append( "ReplSize", -1 ).append( "ConsistencyStrategy", 2 ) );
    ...
    public void test( String ftmask, int ftlevel, int ftfusingtimeout )
        ...
        mgr.addTask(
                new putLob( testClName, secondaryLocationNodeName, ftmask ) );
        mgr.execute();
