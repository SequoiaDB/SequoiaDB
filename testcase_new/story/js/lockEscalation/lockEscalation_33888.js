/******************************************************************************
 * @Description   : seqDB-33888:执行批量删除导致锁升级，锁升级时读取的是磁盘的记录
 * @Author        : tangtao
 * @CreateTime    : 2023.11.07
 * @LastEditTime  : 2023.11.07
 * @LastEditors   : tangtao
 ******************************************************************************/
testConf.clName = COMMCLNAME + "_lockEscalation_33888";

main( test );
function test ( testPara )
{
   var cl = testPara.testCL;
   var indexName = "test_33888";
