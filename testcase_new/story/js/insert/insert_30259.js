/******************************************************************************
 * @Description   : seqDB-30259:批量插入，验证flag:SDB_INSERT_REPLACEONDUP_ID以及option:ReplaceOnDupID
 * @Author        : Cheng Jingjing
 * @CreateTime    : 2023.02.20
 * @LastEditTime  : 2023.03.10
 * @LastEditors   : liuli
******************************************************************************/
testConf.clName = COMMCLNAME + "_30259";
main( test );
...
function test ( testPara )
{
   ...
   var res = cl.insert( recsArray, SDB_INSERT_REPLACEONDUP_ID ).toObj();
   var exp = { "InsertedNum": 2, "DuplicatedNum": 1, "ModifiedNum": 1 };
   assert.equal( res, exp );
   var expRecs = [{ _id: 1, a: 1, b: 3 }, { _id: 11, a: 11 }, { _id: 22, a: 22, b: 22 }];
   ...
   res = cl.insert( recsArray, { ReplaceOnDupID: true } ).toObj();
   exp = { "InsertedNum": 2, "DuplicatedNum": 1, "ModifiedNum": 1 };
   assert.equal( res, exp );
   expRecs = [{ _id: 1, a: 11 }, { _id: 22, a: 22, b: 22 }, { _id: 33, a: 33, b: 33 }];
   checkRecords( cl, expRecs, false );
   cl.truncate();
