/******************************************************************************
 * @Description   : seqDB-27842:CL执行truncate,跳过回收站
 * @Author        : HuangHaimei
 * @CreateTime    : 2022.09.26
 * @LastEditTime  : 2023.04.14
 * @LastEditors   : HuangHaimei
 ******************************************************************************/
testConf.csName = COMMCSNAME + "_27842_1";
testConf.csOpt = { LobPageSize: 262144 };
testConf.clName = COMMCLNAME + "_27842_1";
...
function test ( testPara )
{
   ...
   var filePath = WORKDIR + "/lob27842_1/";
   var fileName = "filelob_27842_1";
