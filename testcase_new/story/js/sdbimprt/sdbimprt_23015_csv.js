...
function test ( args )
{
   ...
   var importData1 = ",eee\n" + "1,aaa\n" + "2,bbb\n" + "3,ccc\n";
   // 准备导入数据{ "b": "ttt" }, { "a": 1, "b": "aaa" }, { "a": 2, "b": "bbb" }, { "a": 3, "b": "ccc" }
   var importData2 = ",ttt\n" + "1,aaa\n" + "2,bbb\n" + "3,ccc\n";

   // 指定唯一索引，replacekeydup 和 allowkeydup 均为默认值
   prepareIndexAndDataInCL( cl, indexName, indexDef, insertRecs, indexOption1 );
   var expectResult = [{ "b": "eee" }, { "b": "eee" }, { "a": 1, "b": "sss" }, { "a": 2, "b": "bbb" }, { "a": 3, "b": "ccc" }];
   testImprt( cl, importData1, sdbimprtOption, expectResult );
   var expectResult = [{ "b": "eee" }, { "b": "eee" }, { "b": "eee" }, { "a": 1, "b": "sss" }, { "a": 2, "b": "bbb" }, { "a": 3, "b": "ccc" }];
   testImprt( cl, importData1, sdbimprtOption, expectResult );

   // 指定强制唯一索引，replacekeydup 为 true, allowkeydup 为默认值
...
{
   var filename = tmpFileDir + "23015.csv";
