/******************************************************************************
 * @Description   : seqDB-24198:TransPropagateMode为never，事务中使用数据源
 * @Author        : liuli
 * @CreateTime    : 2021.05.27
 * @LastEditTime  : 2021.05.27
 * @LastEditors   : liuli
 ******************************************************************************/
testConf.clName = COMMCLNAME + "_24198";
...
{
   var cl = args.testCL;
   var dataSrcName = "datasrc24198";
   var csName = "cs_24198";
   var clName = "cl_24198";
   var srcCSName = "datasrcCS_24198";
   var docs = [{ a: 1, b: 1 }, { a: 2, b: "test" }];

   commDropCS( datasrcDB, srcCSName );
   clearDataSource( csName, dataSrcName );
   commCreateCL( datasrcDB, srcCSName, clName );
   db.createDataSource( dataSrcName, datasrcUrl, userName, passwd, "SequoiaDB", { TransPropagateMode: "never" } );
