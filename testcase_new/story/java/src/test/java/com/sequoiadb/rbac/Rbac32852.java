...
/**
 * @Description seqDB-32852:角色添加继承关系，子角色包含父角色
 * @Author tangtao
 * @Date 2023.08.30
 ...
 */
@Test(groups = "rbac")
public class Rbac32852 extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String user = "user_32852";
    private String password = "passwd_32852";
    private String hierarchicRoleName1 = "role_32852_1";
    private String hierarchicRoleName2 = "role_32852_2";
    private String csName = "cs_32852";
    private String clName = "cl_32852";
    ...
    private void testAccessControl( Sequoiadb sdb ) {
        String[] actions1 = { "testCS", "testCL", "find", "insert", "update",
                "remove" };
        String[] actions2 = { "testCS", "testCL", "find", "insert", "update",
                "remove", "getDetail", "createIndex", "dropIndex" };
