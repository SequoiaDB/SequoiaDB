...
/**
 * @description seqDB-23965:并发删除索引和数据切分(从一个组100%切分到另一个组)
 * @author wuyan
 * @date 2021.4.8
 * @version 1.10
 */

public class IndexConsistent23965B extends SdbTestBase {
    private boolean runSuccess = false;
    private Sequoiadb sdb = null;
    private CollectionSpace cs;
    private DBCollection cl;
    private String clName = "cl_Index23965b";
    private String indexName1 = "testindex23965b_1";
    private String indexName2 = "testindex23965b_2";
    private String indexName3 = "testindex23965b_3";
