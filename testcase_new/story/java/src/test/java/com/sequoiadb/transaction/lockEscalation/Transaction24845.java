...
/**
 * @author yaokang
 * @description seqDB-24845:CL 层面 SIX 与 X 的兼容性
 * @date 2021/12/14
 * @updateUser yaokang
...
public class Transaction24845 extends SdbTestBase {
    private Sequoiadb db1;
    private Sequoiadb db2;
    private final String cl1Name = "cl_24845_1";
    private final String cl2Name = "cl_24845_2";
    ...
    public void setUp() {
        ...
        LockEscalationUtil.insertData( db1, csName, cl1Name, 10 );
    }
    ...
    public void test() {
        ...
        try {
            LockEscalationUtil.insertData( db1, csName, cl1Name, 10 );
            LockEscalationUtil.queryData( db1, csName, cl1Name, 0, 10 );
            LockEscalationUtil.checkCLLockType( db1,
                    LockEscalationUtil.LOCK_SIX );
