...
public class ShareLob20338B extends SdbTestBase {
    ...
    private String clName = "cl20338B";
    private String mainCLName = "mainCL20338B";
    private String subCLName = "subCL20338B";
