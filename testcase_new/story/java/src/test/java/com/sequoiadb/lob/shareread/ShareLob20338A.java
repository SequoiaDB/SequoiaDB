...
/**
 * @Description seqDB-20338 SHARED_READ和SHARED_READ|WRITE并发读lob
 * @author luweikang
 * @Date 2019.8.26
 */

public class ShareLob20338A extends SdbTestBase {
    ...
    private String clName = "cl20338A";
    private String mainCLName = "mainCL20338A";
    private String subCLName = "subCL20338A";
    ...
    public void testLob( String clName, byte[] readLobBuff ) {
        ...
        // SHARED_READ读区域和SHARED_READ|WRITE读区域相离
        ...
        // SHARED_READ读区域和SHARED_READ|WRITE读区域相交
        try {
