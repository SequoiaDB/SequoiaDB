...
/**
 * @Description seqDB-32837:同时更新角色权限和继承关系
 * @Author tangtao
 * @Date 2023.08.30
 ...
 */
@Test(groups = "rbac")
public class Rbac32837 extends SdbTestBase {
    private Sequoiadb sdb = null;
    private String user = "user_32837";
    private String password = "passwd_32837";
    private String roleName1 = "role_32837_1";
    private String roleName2 = "role_32837_2";
    private String roleName3 = "role_32837_3";
    private String roleName4 = "role_32837_4";
    private String csName = "cs_32837";
    private String clName = "cl_32837";
    ...
    private void testAccessControl( Sequoiadb sdb ) {
        ...
        String[] actions5 = { "testCS", "testCL", "find" };
        ...
        try ( Sequoiadb userSdb = new Sequoiadb( SdbTestBase.coordUrl, user,
            ...
            // 更新角色，添加权限并更改继承内容
            action = RbacUtils.arrayToCommaSeparatedString( actions5 );
