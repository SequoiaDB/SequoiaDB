...
/**
 * @Description seqDB-23406:使用数据源创建集合空间并发执行lob操作
 * @author liuli
 * @Date 2021.02.25
 * @version 1.10
 */
public class DataSource23406 extends SdbTestBase {
    private Sequoiadb sdb = null;
    private Sequoiadb srcdb = null;
    private String dataSrcName = "datasource23406";
    private String csName = "cs_23406";
    private String srcCSName = "cssrc_23406";
    private String clName = "cl_23406";
