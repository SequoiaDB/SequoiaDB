...
/**
 * @Description: seqDB-24829:CL 层面 IS 与 S 的兼容性
 * @Author Yang Qincheng
 * @Date 2021.12.10
 */
@Test(groups = "lockEscalation")
public class Transaction24829 extends SdbTestBase {
    private Sequoiadb db1;
    private Sequoiadb db2;
    private final String clName = "cl_24829";
    ...
    public void test() {
        ...
        try {
            ...
            LockEscalationUtil.queryData( db2, csName, clName, 10, 30 );
            LockEscalationUtil.checkCLLockType( db2, LockEscalationUtil.LOCK_S );
        } finally {
            db1.commit();
            db2.commit();
        }
