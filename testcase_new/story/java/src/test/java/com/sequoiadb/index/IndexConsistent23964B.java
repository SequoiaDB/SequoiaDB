...
/**
 * @description seqDB-23964:并发创建索引和数据切分(从一个数据组100%另一个数据组)
 * @author wuyan
 * @date 2021.4.8
 * @version 1.10
 */

class IndexConsistent23964B extends SdbTestBase {
    private boolean runSuccess = false;
    private Sequoiadb sdb = null;
    private CollectionSpace cs;
    private DBCollection cl;
    private String clName = "cl_Index23964b";
    ...
    public void test() throws Exception {
        String indexName1 = "testindex23964B_a";
        String indexName2 = "testindex23964B_b";
        ThreadExecutor es = new ThreadExecutor();
        es.addWorker( new CreateIndex( indexName1, indexName2 ) );
