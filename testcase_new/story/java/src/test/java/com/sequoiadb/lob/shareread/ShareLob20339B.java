...
public class ShareLob20339B extends SdbTestBase {
    ...
    private String clName = "cl20339B";
    private String mainCLName = "mainCL20339B";
    private String subCLName = "subCL20339B";
