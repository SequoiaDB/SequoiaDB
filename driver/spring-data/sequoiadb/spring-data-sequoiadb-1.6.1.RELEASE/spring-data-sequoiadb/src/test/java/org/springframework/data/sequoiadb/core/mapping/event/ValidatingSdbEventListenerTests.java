...
/**
 * Integration test for {@link ValidatingSequoiadbEventListener}.
 * 
 * @see DATA_JIRA-36
...
public class ValidatingSdbEventListenerTests {
	...
	public void shouldNotThrowAnyExceptions() {
		sequoiadbTemplate.save(new User("john smith", 18));
	}
}
