...
import org.springframework.data.sequoiadb.core.SpecialDoc;
...
//		String expectedFields = "{ \"products\" : { \"$elemMatch\" : { \"name\" : \"milk\" } } , \"comments.$\" : 2 }";
	...
	public void shouldReturnClassHierarchyOfRestrictedTypes() {
		...
		assertThat(
				query.toString(),
				is("Query: { \"name\" : \"foo\", \"_$RESTRICTED_TYPES\" : [ { $java : class org.springframework.data.sequoiadb.core.SpecialDoc } ] }, Fields: null, Sort: null, Hint: {  }, Limit: -1, Skip: 0, Flags: 0"));
