...
import org.springframework.data.sequoiadb.core.index.TextIndexed;
...
import org.springframework.data.sequoiadb.repository.support.SequoiadbRepositoryFactory;
...
public class SequoiadbRepositoryTextSearchIntegrationTests {

	public static @ClassRule
    SequoiadbVersionRule versionRule = SequoiadbVersionRule.atLeast(new Version(2, 6, 0));
	...
	public void setUp() {
		...
		this.repo = new SequoiadbRepositoryFactory(this.template).getRepository(FullTextRepository.class);
	}
	...
	public static class Configuration extends AbstractSequoiadbConfiguration {

		@Override
		protected String getDatabaseName() {
			return ClassUtils.getShortNameAsProperty(SequoiadbRepositoryTextSearchIntegrationTests.class);
		}
	...
	static interface FullTextRepository extends SequoiadbRepository<FullTextDocument, String> {
