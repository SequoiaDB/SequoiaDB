...
public class SimpleSequoiadbRepositoryTests {
	...
	private SequoiadbEntityInformation<Person, String> personEntityInformation = new CustomizedPersonInformation();
	private SimpleSequoiadbRepository<Person, String> repository;

	@Before
	public void setUp() {
		repository = new SimpleSequoiadbRepository<Person, String>(personEntityInformation, template);
	...
	private static class CustomizedPersonInformation implements SequoiadbEntityInformation<Person, String> {
