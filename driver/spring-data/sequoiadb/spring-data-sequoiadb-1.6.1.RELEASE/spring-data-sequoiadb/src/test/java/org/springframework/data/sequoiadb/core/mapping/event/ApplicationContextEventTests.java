...
import org.springframework.data.sequoiadb.core.mapping.PersonPojoStringId;
...
public class ApplicationContextEventTests {
	...
	public void setUp() throws Exception {
		...
		template = applicationContext.getBean(SequoiadbTemplate.class);
	...
	public void beforeSaveEvent() {
		...
		BSONObject dbo = beforeSaveEvent.getDBObject();
	...
	private void comparePersonAndDbo(PersonPojoStringId p, PersonPojoStringId p2, BSONObject dbo) {
		assertEquals(p.getId(), p2.getId());
		assertEquals(p.getText(), p2.getText());

		assertEquals("org.springframework.data.sequoiadb.core.mapping.PersonPojoStringId", dbo.get("_class"));
