 ...
 */
@SupportedAnnotationTypes({ "com.mysema.query.annotations.*", "org.springframework.data.sequoiadb.core.mapping.*" })
@SupportedSourceVersion(SourceVersion.RELEASE_6)
public class SequoiadbAnnotationProcessor extends AbstractQuerydslProcessor {
