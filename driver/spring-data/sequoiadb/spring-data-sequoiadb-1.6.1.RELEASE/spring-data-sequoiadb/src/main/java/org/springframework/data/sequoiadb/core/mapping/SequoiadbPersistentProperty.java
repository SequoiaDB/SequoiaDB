...
/**
 * SequoiaDB specific {@link org.springframework.data.mapping.PersistentProperty} extension.
 * 
 ...
 */
public interface SequoiadbPersistentProperty extends PersistentProperty<SequoiadbPersistentProperty> {
	...
	/**
	 * Returns whether the propert is a {@link org.springframework.data.sequoiadb.assist.DBRef}. If this returns {@literal true} you can expect
	...
	/**
	 * Simple {@link Converter} implementation to transform a {@link SequoiadbPersistentProperty} into its field name.
	 * 

	 */
	public enum PropertyToFieldNameConverter implements Converter<SequoiadbPersistentProperty, String> {
