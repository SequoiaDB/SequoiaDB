...
public class OperatorNode extends ExpressionNode {
	...
	/* 
	 * (non-Javadoc)
	 * @see org.springframework.data.sequoiadb.core.spel.ExpressionNode#isMathematicalOperation()
	 */
	@Override
	...
	/**
	 * Returns the Sdb expression of the operator.
	 * 
	 * @return
	 */
	public String getSequoiadbOperator() {
