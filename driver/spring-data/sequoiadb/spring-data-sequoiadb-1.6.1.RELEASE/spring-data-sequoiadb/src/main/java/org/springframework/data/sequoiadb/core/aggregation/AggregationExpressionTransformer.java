...
import org.springframework.data.sequoiadb.core.aggregation.AggregationExpressionTransformer.AggregationExpressionTransformationContext;
...
import org.springframework.data.sequoiadb.core.spel.ExpressionTransformer;
...
interface AggregationExpressionTransformer extends
	...
	public static class AggregationExpressionTransformationContext<T extends ExpressionNode> extends
		...
		public AggregationExpressionTransformationContext(T currentNode, ExpressionNode parentNode,
														  BSONObject previousOperationObject, AggregationOperationContext context) {
