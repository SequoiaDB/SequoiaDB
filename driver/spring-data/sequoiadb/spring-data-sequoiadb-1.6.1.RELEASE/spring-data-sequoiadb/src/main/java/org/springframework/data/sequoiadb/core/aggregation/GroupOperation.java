 ...
 * 
 * @see http://docs.sequoiadb.org/manual/reference/aggregation/group/#stage._S_group
...
public class GroupOperation implements FieldsExposingAggregationOperation {
	...
	/* 
	 * (non-Javadoc)
	 * @see org.springframework.data.sequoiadb.core.aggregation.AggregationOperationContext#getFields()
	 */
	@Override
	...
	public BSONObject toDBObject(AggregationOperationContext context) {
		...
		BasicBSONObject operationObject = new BasicBSONObject();
		...
		return new BasicBSONObject("$group", operationObject);
	}
	...
	static class Operation implements AggregationOperation {
		...
		public BSONObject toDBObject(AggregationOperationContext context) {
			return new BasicBSONObject(key, new BasicBSONObject(op.toString(), getValue(context)));
		}
