...
import org.springframework.data.sequoiadb.core.mapping.event.AuditingEventListener;
import org.springframework.data.support.IsNewStrategyFactory;
import org.springframework.util.Assert;

/**
 * {@link ImportBeanDefinitionRegistrar} to enable {@link EnableSequoiadbAuditing} annotation.
 * 


 */
class SequoiadbAuditingRegistrar extends AuditingBeanDefinitionRegistrarSupport {
	...
	protected Class<? extends Annotation> getAnnotation() {
		return EnableSequoiadbAuditing.class;
	}
	...
	protected String getAuditingHandlerBeanName() {
		return "sequoiadbAuditingHandler";
	}
	...
	/**
	 * Register default bean definitions for a {@link SequoiadbMappingContext} and an {@link IsNewStrategyFactory} in case we
