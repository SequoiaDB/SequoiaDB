...
public class Criteria_bak implements CriteriaDefinition {
	...
	public Criteria_bak is(Object o) {
		...
		if (!isValue.equals(NOT_SET)) {
			throw new InvalidSequoiadbApiUsageException(
	 ...
	 * 
	 * @see http://docs.sequoiadb.org/manual/reference/operator/query/ne/
	 * @param o
	 * @return
	 */
	 ...
	 * 
	 * @see http://docs.sequoiadb.org/manual/reference/operator/query/lt/
	 * @param o
	 * @return
	 */
	 ...
	 * 
	 * @see http://docs.sequoiadb.org/manual/reference/operator/query/lte/
	 * @param o
	 * @return
	 */
	 ...
	 * 
	 * @see http://docs.sequoiadb.org/manual/reference/operator/query/gt/
	 * @param o
	 * @return
	 */
	 ...
	 * 
	 * @see http://docs.sequoiadb.org/manual/reference/operator/query/gte/
	 * @param o
	 * @return
	 */
	 ...
	 * 
	 * @see http://docs.sequoiadb.org/manual/reference/operator/query/in/
	 * @param o the values to match against
	 * @return
	 */
	public Criteria_bak in(Object... o) {
		if (o.length > 1 && o[1] instanceof Collection) {
			throw new InvalidSequoiadbApiUsageException("You can only pass in one argument of type "
	 ...
	 * 
	 * @see http://docs.sequoiadb.org/manual/reference/operator/query/nin/
	 * @param o
	 * @return
	 */
	 ...
	 * 
	 * @see http://docs.sequoiadb.org/manual/reference/operator/query/mod/
	 * @param value
	 * @param remainder
	 * @return
	 */
	 ...
	 * 
	 * @see http://docs.sequoiadb.org/manual/reference/operator/query/all/
	 * @param o
	 * @return
	 */
	 ...
	 * 
	 * @see http://docs.sequoiadb.org/manual/reference/operator/query/size/
	 * @param s
	 * @return
	 */
	 ...
	 * 
	 * @see http://docs.sequoiadb.org/manual/reference/operator/query/exists/
	 * @param b
	 * @return
	 */
	 ...
	 * 
	 * @see http://docs.sequoiadb.org/manual/reference/operator/query/type/
	 * @param t
	 * @return
	 */
	 ...
	 * 
	 * @see http://docs.sequoiadb.org/manual/reference/operator/query/not/
	 * @return
	 */
	 ...
	 * 
	 * @see http://docs.sequoiadb.org/manual/reference/operator/query/regex/
	 * @param re
	 * @return
	 */
	 ...
	 * 
	 * @see http://docs.sequoiadb.org/manual/reference/operator/query/regex/
	 * @see http://docs.sequoiadb.org/manual/reference/operator/query/regex/#op._S_options
	 * @param re
	 * @param options
	 * @return
	 */
	...
	/**
	 * Creates a geospatial criterion using a {@literal $within $centerSphere} operation. This is only available for Sdb
	 * 1.7 and higher.
	 * 
	 * @see http://docs.sequoiadb.org/manual/reference/operator/query/geoWithin/
	 * @see http://docs.sequoiadb.org/manual/reference/operator/query/centerSphere/
	 ...
	 * 
	 * @see http://docs.sequoiadb.org/manual/reference/operator/query/near/
	...
	/**
	 * Creates a geospatial criterion using a {@literal $nearSphere} operation. This is only available for Sdb 1.7 and
	 * higher.
	 * 
	 * @see http://docs.sequoiadb.org/manual/reference/operator/query/nearSphere/
	 * @param point must not be {@literal null}
	 * @return
	 */
	 ...
	 * 
	 * @see http://docs.sequoiadb.org/manual/reference/operator/query/maxDistance/
	 * @param maxDistance
	 * @return
	 */
	 ...
	 * 
	 * @see http://docs.sequoiadb.org/manual/reference/operator/query/elemMatch/
	 * @param c
	 * @return
	 */
	 ...
	 * <p>
	 * Note that sequoiadb doesn't support an $or operator to be wrapped in a $not operator.
	 * <p>
	 * 
	 ...
	 * <p>
	 * Note that sequoiadb doesn't support an $nor operator to be wrapped in a $not operator.
	 * <p>
	 * 
	 ...
	 * <p>
	 * Note that sequoiadb doesn't support an $and operator to be wrapped in a $not operator.
	 * <p>
	 * 
	...
	/*
	 * (non-Javadoc)
	 * @see org.springframework.data.sequoiadb.core.query.CriteriaDefinition#getCriteriaObject()
	 */
	public BSONObject getCriteriaObject() {
		...
		if (this.criteriaChain.size() == 1) {
			...
			BSONObject criteriaObject = new BasicBSONObject();
			for (Criteria_bak c : this.criteriaChain) {
				BSONObject dbo = c.getSingleCriteriaObject();
	...
	protected BSONObject getSingleCriteriaObject() {
		...
		for (String k : this.criteria.keySet()) {
			...
			if (not) {
				BSONObject notDbo = new BasicBSONObject();
				notDbo.put(k, value);
				dbo.put("$not", notDbo);
				not = false;
			} else {
		...
		if (!StringUtils.hasText(this.key)) {
			if (not) {
				return new BasicBSONObject("$not", dbo);
			}
			return dbo;
		}

		BSONObject queryCriteria = new BasicBSONObject();
	...
	private BasicBSONList createCriteriaList(Criteria_bak[] criteria) {
	...
	private void setValue(BSONObject dbo, String key, Object value) {
