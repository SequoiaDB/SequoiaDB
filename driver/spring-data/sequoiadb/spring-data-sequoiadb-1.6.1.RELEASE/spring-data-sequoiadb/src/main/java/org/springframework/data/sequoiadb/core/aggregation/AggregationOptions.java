 ...
 * aggregation options can be found in the SequoiaDB reference documentation
 * http://docs.sequoiadb.org/manual/reference/command/aggregate/#aggregate
 * 
...
public class AggregationOptions {
	 ...
	 */
	public AggregationOptions(boolean allowDiskUse, boolean explain, BSONObject cursor) {
	 ...
	 * @return
	 */
	BSONObject applyAndReturnPotentiallyChangedCommand(BSONObject command) {

		BSONObject result = new BasicBSONObject(command.toMap());
	...
	/**
	 * Returns a {@link BSONObject} representation of this {@link AggregationOptions}.
	 * 
	 * @return
	 */
	...
	public static class Builder {
		 ...
		 * @return
		 */
		public Builder cursor(BSONObject cursor) {
