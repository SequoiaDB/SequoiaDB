...
/**
 * Wrapper class to contain useful converters for the usage with Sdb.
 * 



 */
abstract class SequoiadbConverters {

	/**
	 * Private constructor to prevent instantiation.
	 */
	private SequoiadbConverters() {}
	...
	@ReadingConverter
	public static enum DBObjectToStringConverter implements Converter<BSONObject, String> {

		INSTANCE;

		@Override
		public String convert(BSONObject source) {
			return source == null ? null : source.toString();
		}
	}
