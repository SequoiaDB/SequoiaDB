...
import org.springframework.data.sequoiadb.core.convert.SequoiadbConverters.BigIntegerToStringConverter;
import org.springframework.data.sequoiadb.core.convert.SequoiadbConverters.DBObjectToStringConverter;
...
import org.springframework.data.sequoiadb.core.convert.SequoiadbConverters.StringToURLConverter;
import org.springframework.data.sequoiadb.core.convert.SequoiadbConverters.TermToStringConverter;
import org.springframework.data.sequoiadb.core.convert.SequoiadbConverters.URLToStringConverter;
 ...
 * around them. The converters are pretty much builds up two sets of types which Sdb basic types {@see #SEQUOIADB_TYPES}
...
public class CustomConversions {
	...
	private static final String READ_CONVERTER_NOT_SIMPLE = "Registering converter from %s to %s as reading converter although it doesn't convert from a Sdb supported type! You might wanna check you annotation setup at the converter implementation.";
	private static final String WRITE_CONVERTER_NOT_SIMPLE = "Registering converter from %s to %s as writing converter although it doesn't convert to a Sdb supported type! You might wanna check you annotation setup at the converter implementation.";
	...
	public CustomConversions(List<?> converters) {
		...
		this.simpleTypeHolder = new SimpleTypeHolder(customSimpleTypes, SequoiadbSimpleTypes.HOLDER);
	}
	...
	/**
	 * Returns whether we have a custom conversion registered to write into a Sdb native type. The returned type might
	 ...
	 * of the given Sdb native target type.
	 * 
	 * @param sourceType must not be {@literal null}.
	 * @param requestedTargetType
	 * @return
