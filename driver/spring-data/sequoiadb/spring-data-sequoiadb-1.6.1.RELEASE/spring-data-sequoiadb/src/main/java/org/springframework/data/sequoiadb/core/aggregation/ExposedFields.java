...
public final class ExposedFields implements Iterable<ExposedField> {
	...
	static class ExposedField implements Field {
		...
		/* 
		 * (non-Javadoc)
		 * @see org.springframework.data.sequoiadb.core.aggregation.Field#getKey()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see org.springframework.data.sequoiadb.core.aggregation.Field#getTarget()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see org.springframework.data.sequoiadb.core.aggregation.Field#isAliased()
		 */
		@Override
