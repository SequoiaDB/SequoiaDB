...
/**
 * Interface that specifies a basic set of SequoiaDB operations. Implemented by {@link SequoiadbTemplate}. Not often used but
 * a useful option for extensibility and testability (as it can be easily mocked, stubbed, or be the target of a JDK
 * proxy).
 *
 */
public interface SequoiadbOperations {
	...
	/**
	 * Execute the a SequoiaDB command expressed as a JSON string. This will call the method JSON.parse that is part of the
	 * SequoiaDB driver to convert the JSON string to a BSONObject. Any errors that result from executing this command will be
	 * converted into Spring's DAO exception hierarchy.
	 *
	 * @param jsonCommand a SequoiaDB command expressed as a JSON string.
	 */
	CommandResult executeCommand(String jsonCommand);

	/**
	 * Execute a SequoiaDB command. Any errors that result from executing this command will be converted into Spring's DAO
	 * exception hierarchy.
	 *
	 * @param command a SequoiaDB command
	 */
	CommandResult executeCommand(BSONObject command);
	 ...
	 */
	CommandResult executeCommand(BSONObject command, int options);

	/**
	 * Execute a SequoiaDB query and iterate over the query results on a per-document basis with a DocumentCallbackHandler.
	 * 
	 ...
	 * 
	 * @param <T> return type
	 * @param action callback object that specifies the SequoiaDB actions to perform on the passed in DB instance.
	 ...
	 * @param <T> return type
	 * @param action callback object that specifies the SequoiaDB action
	 * @return a result object returned by the action or <tt>null</tt>
	 */
	 ...
	 * @param action callback object that specifies the SequoiaDB action the callback action.
	 * @return a result object returned by the action or <tt>null</tt>
	 */
	 ...
	 * href=http://www.sequoiadb.org/display/DOCS/Java+Driver+Concurrency>Java Driver Concurrency</a>}
	 * <p/>
	 * Allows for returning a result object, that is a domain object or a collection of domain objects.
	 * 
	 * @param <T> return type
	 * @param action callback that specified the SequoiaDB actions to perform on the DB instance
	 * @return a result object returned by the action or <tt>null</tt>
	 */
	 ...
	 * <p/>
	 * The object is converted from the SequoiaDB native representation using an instance of {@see SequoiadbConverter}. Unless
	 * configured otherwise, an instance of MappingSequoiadbConverter will be used.
	 * <p/>
	...
	/**
	 * Triggers <a href="http://docs.sequoiadb.org/manual/reference/method/db.collection.findAndModify/">findAndModify<a/>
	 ...
	 * database.
	 * <p/>
	 * The object is converted from the SequoiaDB native representation using an instance of {@see SequoiadbConverter}.
	 * <p/>
	 * The query is specified as a {@link Query} which can be created either using the {@link BasicQuery} or the more
	 * feature rich {@link Query}.
	 * 
	 ...
	 * <p/>
	 * The object is converted to the SequoiaDB native representation using an instance of {@see SequoiadbConverter}.
	 * <p/>
	 * If you object has an "Id' property, it will be set with the generated Id from SequoiaDB. If your Id property is a
	 * String then SequoiaDB ObjectId will be used to populate that string. Otherwise, the conversion from ObjectId to your
	 ...
	 * <p/>
	 * The object is converted to the SequoiaDB native representation using an instance of {@see SequoiadbConverter}. Unless
	 * configured otherwise, an instance of MappingSequoiadbConverter will be used.
	 * <p/>
	 * Insert is used to initially store the object into the database. To update an existing object use the save method.
	 * 
	...
	/**
	 * Returns the underlying {@link SequoiadbConverter}.
	 * 
	 * @return
	 */
	SequoiadbConverter getConverter();
}
