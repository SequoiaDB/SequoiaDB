...
class ConverterRegistration {
	...
	/**
	 * Returns whether the source type is a Sdb simple one.
	 * 
	 * @return
	 */
	public boolean isSimpleSourceType() {
		return isSequoiadbBasicType(convertiblePair.getSourceType());
	}

	/**
	 * Returns whether the target type is a Sdb simple one.
	 * 
	 * @return
	 */
	public boolean isSimpleTargetType() {
		return isSequoiadbBasicType(convertiblePair.getTargetType());
	}

	/**
	 * Returns whether the given type is a type that Sdb can handle basically.
	 * 
	 * @param type
	 * @return
	 */
	private static boolean isSequoiadbBasicType(Class<?> type) {
		return SequoiadbSimpleTypes.HOLDER.isSimpleType(type);
	}
}