...
/**
 * Event being thrown before a document is deleted. The {@link BSONObject} held in the event will represent the query
...
public class BeforeDeleteEvent<T> extends AbstractDeleteEvent<T> {
	...
	/**
	 * Creates a new {@link BeforeDeleteEvent} for the given {@link BSONObject} and type.
	 * 
	 * @param dbo must not be {@literal null}.
	 * @param type can be {@literal null}.
	 */
	public BeforeDeleteEvent(BSONObject dbo, Class<T> type) {
		super(dbo, type);
	}
}
