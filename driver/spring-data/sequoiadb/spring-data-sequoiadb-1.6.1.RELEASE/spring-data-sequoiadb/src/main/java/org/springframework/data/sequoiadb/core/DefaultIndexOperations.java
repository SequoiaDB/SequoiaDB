...
public class DefaultIndexOperations implements IndexOperations {
	 ...
	 */
	public DefaultIndexOperations(SequoiadbOperations sequoiadbOperations, String collectionName) {
	...
	/*
	 * (non-Javadoc)
	 * @see org.springframework.data.sequoiadb.core.IndexOperations#ensureIndex(org.springframework.data.sequoiadb.core.index.IndexDefinition)
	 */
	public void ensureIndex(final IndexDefinition indexDefinition) {
		sequoiadbOperations.execute(collectionName, new CollectionCallback<Object>() {
	...
	/*
	 * (non-Javadoc)
	 * @see org.springframework.data.sequoiadb.core.IndexOperations#dropIndex(java.lang.String)
	 */
	public void dropIndex(final String name) {
		sequoiadbOperations.execute(collectionName, new CollectionCallback<Void>() {
	...
	/*
	 * (non-Javadoc)
	 * @see org.springframework.data.sequoiadb.core.IndexOperations#dropAllIndexes()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see org.springframework.data.sequoiadb.core.IndexOperations#resetIndexCache()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see org.springframework.data.sequoiadb.core.IndexOperations#getIndexInfo()
	 */
	public List<IndexInfo> getIndexInfo() {

		return sequoiadbOperations.execute(collectionName, new CollectionCallback<List<IndexInfo>>() {
			public List<IndexInfo> doInCollection(DBCollection collection) throws BaseException, DataAccessException {
				List<BSONObject> dbObjectList = collection.getIndexInfo();
				return getIndexData(dbObjectList);
			}

			private List<IndexInfo> getIndexData(List<BSONObject> dbObjectList) {

				List<IndexInfo> indexInfoList = new ArrayList<IndexInfo>();

				for (BSONObject ix : dbObjectList) {
