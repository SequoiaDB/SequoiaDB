...
/**
 * A thread-safe client view of a logical database in a SequoiaDB cluster. A DB instance can be achieved from a {@link SdbClient} instance
 * using code like:
 * <pre>
 * {@code
 * SdbClient sdbClient = new SdbClient();
 * DB db = sdbClient.getDB("<db name>");
 * }</pre>
 *
 * @see SdbClient
 */
public abstract class DB {
     ...
     * <p/>
     * Following this call and until {@link com.sequoiadb.DB#requestDone()} is called,
     ...
     */
    public DBCollection createCollection( String name, BSONObject options ){
        final String myName = name;
        final BSONObject myOptions = options;

        return _cm.execute(_csName, new CSCallback<DBCollection>(){
            @Override
            public DBCollection doInCS(CollectionSpace cs) throws com.sequoiadb.exception.BaseException {
     ...
     * This method calls {@link DB#command(BSONObject, int)} } with 0 as query option.
     *
     * @param cmd {@code BSONObject} representation of the command to be executed
     * @return result of the command execution
     * @throws BaseException
     */
    public CommandResult command( BSONObject cmd ){
    ...
    public DBCursor executeSelectSql(final String selectSqlCommand) {
         IQueryResult result = _cm.execute(new QueryInSessionCallback<IQueryResult>() {
            @Override
            public IQueryResult doQuery(Sequoiadb db) throws com.sequoiadb.exception.BaseException {
    ...
    public void executeOtherSql(final String otherSqlCommand) {
        _cm.execute(new DBCallback<Void>(){
            @Override
            public Void doInDB(Sequoiadb db) throws com.sequoiadb.exception.BaseException {
    ...
    /**
     * Executes a database command.
     * This method calls {@link DB#command(com.sequoiadb.BSONObject, int, com.sequoiadb.DBEncoder) } with 0 as query option.
     *
     * @param cmd     {@code BSONObject} representation of the command to be executed
     ...
     * @throws BaseException
     */
    public CommandResult command( BSONObject cmd, DBEncoder encoder ){
        throw new UnsupportedOperationException("not supported!");
    }

    /**
     * Executes a database command. This method calls
     * {@link DB#command(com.sequoiadb.BSONObject, int, com.sequoiadb.ReadPreference, com.sequoiadb.DBEncoder) } with the database default read
     * preference.  The only option used by this method was "slave ok", therefore this method has been replaced with
     * {@link com.sequoiadb.DB#command(BSONObject, ReadPreference, DBEncoder)}.
     *
     * @param cmd     {@code BSONObject} representation the command to be executed
     * @param options query options to use
     * @param encoder {@link DBEncoder} to be used for command encoding
     * @return result of the command execution
     * @throws BaseException
     * @deprecated Use {@link com.sequoiadb.DB#command(BSONObject, ReadPreference, DBEncoder)} instead.  This method will be removed in 3.0.
     */
    @Deprecated
    public CommandResult command( BSONObject cmd , int options, DBEncoder encoder ){
        throw new UnsupportedOperationException("not supported!");
    }

    /**
     * Executes a database command. This method calls
     * {@link DB#command(com.sequoiadb.BSONObject, int, com.sequoiadb.ReadPreference, com.sequoiadb.DBEncoder) } with a default encoder.  The only
     * option used by this method was "slave ok", therefore this method has been replaced
     * with {@link com.sequoiadb.DB#command(BSONObject, ReadPreference)}.
     *
     * @param cmd            A {@code BSONObject} representation the command to be executed
     ...
     * @return result of the command execution
     * @throws BaseException
     * @deprecated Use {@link com.sequoiadb.DB#command(BSONObject, ReadPreference)} instead.  This method will be removed in 3.0.
     */
    @Deprecated
    public CommandResult command( BSONObject cmd , int options, ReadPreference readPreference ){
        throw new UnsupportedOperationException("not supported!");
    }
     ...
     * com.sequoiadb.DB#command(BSONObject, ReadPreference, DBEncoder)}.
     *
     * @param cmd            A {@code BSONObject} representation the command to be executed
     * @param options        The query options to use
     * @param readPreference The {@link ReadPreference} for this command (nodes selection is the biggest part of this)
     ...
     */
    @Deprecated
    public CommandResult command( BSONObject cmd , int options, ReadPreference readPreference, DBEncoder encoder ){
        throw new UnsupportedOperationException("not supported!");
    }
     ...
     *
     * @param cmd            The {@code BSONObject} representation the command to be executed
     ...
     * @since 2.12
     */
    public CommandResult command( final BSONObject cmd , final ReadPreference readPreference, final DBEncoder encoder ){
        throw new UnsupportedOperationException("not supported!");
    }
     ...
     * has been replaced with {@link com.sequoiadb.DB#command(BSONObject, ReadPreference)}.
     *
     * @param cmd     The {@code BSONObject} representation the command to be executed
     * @param options The query options to use
     ...
     */
    @Deprecated
    public CommandResult command(BSONObject cmd, int options) {
        throw new UnsupportedOperationException("not supported!");
    }
     ...
     * preference, use this instead of {@link DB#command(com.sequoiadb.BSONObject, int) }
     *
     * @param cmd            The {@code BSONObject} representation the command to be executed
     * @param readPreference Where to execute the command - this will only be applied for a subset of commands
     * @return The result of executing the command, success or failure
     * @since 2.12
     */
    public CommandResult command(final BSONObject cmd, final ReadPreference readPreference) {
        throw new UnsupportedOperationException("not supported!");
    }

    /**
     * Executes a database command. This method constructs a simple dbobject and calls {@link DB#command(com.sequoiadb.BSONObject) }
     *
    ...
    /**
     * Executes a database command. This method constructs a simple dbobject and calls {@link DB#command(com.sequoiadb.BSONObject, int)  }
     *
     * @param cmd     name of the command to be executed
     * @param options query options to use
     * @return result of the command execution
     * @throws BaseException
     * @deprecated Use {@link com.sequoiadb.DB#command(String, ReadPreference)} instead.  This method will be removed in 3.0.
     */
    @Deprecated
    ...
    /**
     * Executes a database command. This method constructs a simple dbobject and calls {@link DB#command(com.sequoiadb.BSONObject, int,
     * com.sequoiadb.ReadPreference)  }. The only option used by this method was "slave ok", therefore this method has been replaced with
     * {@link com.sequoiadb.DB#command(BSONObject, ReadPreference)}.
     *
    ...
    public Set<String> getCollectionNames(){
        ...
        return _cm.execute(_csName, new CSCallback<Set<String>>() {
            @Override
            public Set<String> doInCS(CollectionSpace cs) throws com.sequoiadb.exception.BaseException {
     ...
     *
     * @return {@code BSONObject} with error and status information
     * @throws BaseException
     * @see WriteConcern#ACKNOWLEDGED
     * @deprecated The getlasterror command will not be supported in future versions of SequoiaDB.  Use acknowledged writes instead.
     */
    @Deprecated
     ...
     * @param fsync    if <b>true</b>, wait for {@code sdb} to write this data to disk before returning. Defaults to <b>false</b>.
     * @return {@code BSONObject} with error and status information
     * @throws BaseException
     * @deprecated The getlasterror command will not be supported in future versions of SequoiaDB.  Use acknowledged writes instead.
     * @see WriteConcern#ACKNOWLEDGED
     ...
     * @dochub authenticate
     * @deprecated Please use {@link SdbClient#SdbClient(java.util.List, java.util.List)} to create a client, which
     ...
     * @throws BaseException        if authentication failed due to invalid user/pass, or other exceptions like I/O
    ...
    /**
     * Returns the last error that occurred since start of database or a call to {@link com.sequoiadb.DB#resetError()} The return object
     * will look like:
     * <pre>
     * {@code
    ...
    /**
     * Gets the {@link Sdb} instance
     *
     * @return the instance of {@link Sdb} this database belongs to
     */
    public Sdb getSdb(){
        return _sdb;
    }
