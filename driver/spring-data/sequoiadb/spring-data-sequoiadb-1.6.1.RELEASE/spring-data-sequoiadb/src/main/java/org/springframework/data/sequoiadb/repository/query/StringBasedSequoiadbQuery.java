 ...
 */
public class StringBasedSequoiadbQuery extends AbstractSequoiadbQuery {
	...
	private static final Logger LOG = LoggerFactory.getLogger(StringBasedSequoiadbQuery.class);
	...
	/**
	 * Creates a new {@link StringBasedSequoiadbQuery} for the given {@link SequoiadbQueryMethod} and {@link SequoiadbOperations}.
	 * 
	 * @param method must not be {@literal null}.
	 * @param sequoiadbOperations must not be {@literal null}.
	 */
	public StringBasedSequoiadbQuery(SequoiadbQueryMethod method, SequoiadbOperations sequoiadbOperations) {
		this(method.getAnnotatedQuery(), method, sequoiadbOperations);
	}

	/**
	 * Creates a new {@link StringBasedSequoiadbQuery} for the given {@link String}, {@link SequoiadbQueryMethod} and
	 * {@link SequoiadbOperations}.
	 * 
	 * @param method must not be {@literal null}.
	 * @param template must not be {@literal null}.
	 */
	public StringBasedSequoiadbQuery(String query, SequoiadbQueryMethod method, SequoiadbOperations sequoiadbOperations) {
	...
	/*
	 * (non-Javadoc)
	 * @see org.springframework.data.sequoiadb.repository.query.AbstractSequoiadbQuery#createQuery(org.springframework.data.sequoiadb.repository.query.ConvertingParameterAccessor)
	 */
	@Override
	...
	private static enum ParameterBindingParser {
		...
		private void collectParameterReferencesIntoBindings(List<ParameterBinding> bindings, Object value) {
			...
			if (value instanceof String) {
				...
				BSONObject dbo = (BSONObject) value;
