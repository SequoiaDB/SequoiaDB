...
/**
 * Mark a field to be indexed using SequoiaDB's indexing feature.
 * 
...
public @interface Indexed {
	 ...
	 * 
	 * @see http://docs.sequoiadb.org/manual/core/index-unique/
	 * @return
	 */
	 ...
	 * 
	 * @see http://docs.sequoiadb.org/manual/core/index-sparse/
	 * @return
	 */
	boolean sparse() default false;

	/**
	 * @see http://docs.sequoiadb.org/manual/core/index-creation/#index-creation-duplicate-dropping
	 * @return
	 */
	...
	/**
	 * If set to {@literal true} then SequoiaDB will ignore the given index name and instead generate a new name. Defaults
	 * to {@literal false}.
	 * 
	 * @return
	 * @since 1.5
	 ...
	 * 
	 * @see http://docs.sequoiadb.org/manual/core/indexes/#background-construction
	 * @return
	 */
	 ...
	 * 
	 * @see http://docs.sequoiadb.org/manual/tutorial/expire-data/
	 * @return
	 */
