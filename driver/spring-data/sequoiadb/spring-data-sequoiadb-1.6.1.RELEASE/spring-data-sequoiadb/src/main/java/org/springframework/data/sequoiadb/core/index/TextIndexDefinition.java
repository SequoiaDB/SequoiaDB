...
public class TextIndexDefinition implements IndexDefinition {
	...
	public BSONObject getIndexOptions() {
		...
		BasicBSONObject weightsDbo = new BasicBSONObject();
		for (TextIndexedFieldSpec fieldSpec : fieldSpecs) {
	...
	public static class TextIndexDefinitionBuilder {
		 ...
		 * 
		 * @param language
		 * @see http://docs.sequoiadb.org/manual/tutorial/specify-language-for-text-index/#specify-default-language-text-index
		 * @return
		 */
