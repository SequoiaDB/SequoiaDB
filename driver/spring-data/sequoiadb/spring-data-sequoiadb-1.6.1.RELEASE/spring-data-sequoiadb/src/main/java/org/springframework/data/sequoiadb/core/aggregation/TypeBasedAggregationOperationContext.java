...
public class TypeBasedAggregationOperationContext implements AggregationOperationContext {
	...
	public TypeBasedAggregationOperationContext(Class<?> type,
                                                MappingContext<? extends SequoiadbPersistentEntity<?>, SequoiadbPersistentProperty> mappingContext, QueryMapper mapper) {
	...
	/*
	 * (non-Javadoc)
	 * @see org.springframework.data.sequoiadb.core.aggregation.AggregationOperationContext#getReference(org.springframework.data.sequoiadb.core.aggregation.Field)
	 */
	@Override
	...
	private FieldReference getReferenceFor(Field field) {
		...
		PersistentPropertyPath<SequoiadbPersistentProperty> propertyPath = mappingContext.getPersistentPropertyPath(
				field.getTarget(), type);
		Field mappedField = field(propertyPath.getLeafProperty().getName(),
				propertyPath.toDotPath(SequoiadbPersistentProperty.PropertyToFieldNameConverter.INSTANCE));
