...
public class TextCriteria implements CriteriaDefinition {
	...
	/*
	 * (non-Javadoc)
	 * @see org.springframework.data.sequoiadb.core.query.CriteriaDefinition#getKey()
	 */
	@Override
	...
	public BSONObject getCriteriaObject() {
		...
		BasicBSONObjectBuilder builder = new BasicBSONObjectBuilder();
		...
		return new BasicBSONObject("$text", builder.get());
	}
