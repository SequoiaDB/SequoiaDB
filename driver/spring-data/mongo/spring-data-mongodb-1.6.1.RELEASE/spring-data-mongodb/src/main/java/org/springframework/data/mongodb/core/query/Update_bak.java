...
public class Update_bak {
	...
	/**
	 * Creates an {@link Update_bak} instance from the given {@link DBObject}. Allows to explicitly exlude fields from making
	 ...
	 * create an only-updating {@link Update_bak} instance of a {@link DBObject}, call {@link #set(String, Object)} for each
	 * value in it.
	 * 
	 ...
	 * @return
	 */
	public static Update_bak fromDBObject(DBObject object, String... exclude) {
