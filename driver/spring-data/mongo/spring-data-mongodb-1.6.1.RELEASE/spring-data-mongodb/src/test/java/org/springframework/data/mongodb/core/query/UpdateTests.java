...
public class UpdateTests {
    ...
    public void sdbUpdateMultiOperator() {
        Update update = new Update().set("a",1)
                ...
                .replace("f", new BasicBSONObject("name","sam"));
    ...
    public void sdbUpdateSetOperator() {
        ...
        Update update2 = new Update();
        update2.set("age", 10).set("ID", 10).set("obj", new BasicDBObject().append("a",1));
        System.out.println(update2.getUpdateObject());
    ...
    public void sdbUpdatePullAllOperator() {
        ...
        Update update2 = new Update();
        update2.pullAll("arr1", 1,2,3,4,5).pullAll("arr2","1","2", new BasicDBObject().append("a",1));
        System.out.println(update2.getUpdateObject());
    ...
    public void sdbUpdatePullAllByOperator() {
        ...
        Update update2 = new Update();
        update2.pullAllBy("arr1", 1,2,3,4,5).pullAllBy("arr2","1","2", new BasicDBObject().append("a",1));
        System.out.println(update2.getUpdateObject());
    ...
    public void sdbUpdatePushAllOperator() {
        ...
        Update update2 = new Update();
        update2.pushAll("arr1", 1,2,3,4,5).pushAll("arr2","1","2", new BasicDBObject().append("a",1));
        System.out.println(update2.getUpdateObject());
