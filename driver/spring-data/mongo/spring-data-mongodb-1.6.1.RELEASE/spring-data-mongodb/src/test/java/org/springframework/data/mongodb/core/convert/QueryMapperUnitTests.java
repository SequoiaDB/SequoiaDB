...
public class QueryMapperUnitTests {
	...
	public void convertsAssociationCorrectly() {
		...
		assertThat(referenceObject, is(instanceOf(org.springframework.data.mongodb.assist.DBRef.class)));
	}
	...
	public void convertsInKeywordCorrectly() {
		...
		assertThat(inClause.get(0), is(instanceOf(org.springframework.data.mongodb.assist.DBRef.class)));
		assertThat(inClause.get(1), is(instanceOf(org.springframework.data.mongodb.assist.DBRef.class)));
	}
	...
	public void handleMapWithDBRefCorrectly() {
		...
		mapDbObject.put("test", new org.springframework.data.mongodb.assist.DBRef(null, "test", "test"));
		...
		assertThat(((BasicDBObject) mapped.get("mapWithDBRef")).get("test"), instanceOf(org.springframework.data.mongodb.assist.DBRef.class));
	}
	...
	public void queryMapperShouldMapDBRefPropertyIfNestedInDBObject() {
		...
		assertThat(inObject.get(0), is(instanceOf(org.springframework.data.mongodb.assist.DBRef.class)));
	}
	...
	public void mapsIdReferenceToDBRefCorrectly() {
		...
		DBObject query = new BasicDBObject("reference.id", new org.springframework.data.mongodb.assist.DBRef(null, "reference", id.toString()));
		...
		org.springframework.data.mongodb.assist.DBRef reference = getTypedValue(result, "reference", org.springframework.data.mongodb.assist.DBRef.class);
