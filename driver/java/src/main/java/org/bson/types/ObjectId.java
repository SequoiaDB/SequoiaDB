...
import com.sequoiadb.util.lobid.UtilLobID;
...
public class ObjectId implements Comparable<ObjectId>, java.io.Serializable {
     ...
     * 
     * @return a new instance of UtilLobID. null if it is not a new version lobID
     */
    public UtilLobID getLobID() {
        UtilLobID lobID = null;
        try {
            lobID = new UtilLobID(toString());
        }
        catch (Exception e) {
            //this is not a new version lobID
            //ignore exception
        }
