...
function _getNodeList( PD_LOGGER, db )
{
   var rc    = SDB_OK ;
   var error = null ;
   var nodeList = [] ;
...
function _getNodeConfig( PD_LOGGER, hostRemoval, hostList, hostName, svcname, groupName )
{
   var rc     = SDB_OK ;
   var error  = null ;
   var config = {} ;
...
function _syncConfig( PD_LOGGER )
{
   ...
   connectInfo = _connectSdb( PD_LOGGER, addressList, user, passwd ) ;
   ...
   {
      nodeList = _getNodeList( PD_LOGGER, db ) ;
      for( var index in nodeList )
      {
         ...
         _getNodeConfig( PD_LOGGER, hostRemoval, hostList,
                         hostName, svcname, groupName ) ;
      }
   }
