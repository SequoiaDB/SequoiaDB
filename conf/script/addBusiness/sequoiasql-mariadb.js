...
*******************************************************************************/
/*
@description: add sequoiasql-mariadb business
@modify list:
...
1. Generate plan
   @parameter
      ...
      var BUS_JSON = {"TaskID":90,"Type":2,"TypeDesc":"ADD_BUSINESS","TaskName":"ADD_BUSINESS","Status":0,"StatusDesc":"INIT","AgentHost":"ubuntu-jw-01","AgentService":"11790","Info":{"SdbUser":"sdbadmin","SdbPasswd":"sdbadmin","SdbUserGroup":"sdbadmin_group","ClusterName":"myCluster1","BusinessType":"sequoiasql-mariadb","BusinessName":"myModule1","DeployMod":"","Config":[{"HostName":"ubuntu-jw-01","dbpath":"/sequoiasql-mariadb/database/5432","port":"5432","shared_buffers":"128MB","log_timezone":"PRC","datestyle":"iso, ymd","timezone":"PRC","lc_messages":"zh_CN.UTF-8","lc_monetary":"zh_CN","lc_numeric":"zh_CN","lc_time":"zh_CN","default_text_search_config":"pg_catalog.simple","InstallPath":"/opt/sequoiasql-mariadb"}]},"errno":0,"detail":"","Progress":0,"ResultInfo":[{"HostName":"ubuntu-jw-01","port":"5432","Status":0,"StatusDesc":"INIT","errno":0,"detail":"","Flow":[]}]}
   @return
      RET_JSON: the format is: {"Plan":[[{"TaskID":90,"Info":{"ClusterName":"myCluster1","BusinessType":"sequoiasql-mariadb","BusinessName":"myModule1","Config":{"HostName":"ubuntu-jw-01","dbpath":"/sequoiasql-mariadb/database/5432","port":"5432","shared_buffers":"128MB","log_timezone":"PRC","datestyle":"iso, ymd","timezone":"PRC","lc_messages":"zh_CN.UTF-8","lc_monetary":"zh_CN","lc_numeric":"zh_CN","lc_time":"zh_CN","default_text_search_config":"pg_catalog.simple","InstallPath":"/opt/sequoiasql-mariadb","AgentService":"11790"}},"ResultInfo":{"HostName":"ubuntu-jw-01","port":"5432","Status":0,"StatusDesc":"INIT","errno":0,"detail":"","Flow":[],"Progress":90}}]]}

2. create instance
   @parameter
      var SYS_STEP = "Doit" ;
      var BUS_JSON = {"TaskID":90,"Info":{"ClusterName":"myCluster1","BusinessType":"sequoiasql-mariadb","BusinessName":"myModule1","Config":{"HostName":"ubuntu-jw-01","dbpath":"/sequoiasql-mariadb/database/5432","port":"5432","shared_buffers":"128MB","log_timezone":"PRC","datestyle":"iso, ymd","timezone":"PRC","lc_messages":"zh_CN.UTF-8","lc_monetary":"zh_CN","lc_numeric":"zh_CN","lc_time":"zh_CN","default_text_search_config":"pg_catalog.simple","InstallPath":"/opt/sequoiasql-mariadb","AgentService":"11790"}},"ResultInfo":{"HostName":"ubuntu-jw-01","port":"5432","Status":0,"StatusDesc":"INIT","errno":0,"detail":"","Flow":[],"Progress":90}}
...
function _execSql( PD_LOGGER, cmd, installPath, sockFile, username, sql, database )
{
   var result = null ;
   ...
   try
   {
      result = ExecSsql2( cmd, installPath, sockFile, username, database, sql ) ;
   }
   catch( e )
   {
...
function _createUser( PD_LOGGER, cmd, installPath, sockFile, username, user, passwd )
{
   var emptyPwd = false ;
   var error = null ;
   var str ;
   ...
   try
   {
      _execSql( PD_LOGGER, cmd, installPath, sockFile, username, str ) ;
   }
   catch( e )
   {
      error = e ;
   ...
   if( emptyPwd == true )
   {
      str = sprintf( 'flush privileges;ALTER USER ?@"%" IDENTIFIED BY "";flush privileges;', user ) ;
...
function CreateInst( PD_LOGGER )
{
   ...
   var username      = taskInfo[FIELD_SDBUSER] ;
   ...
   error = _createUser( PD_LOGGER, cmd, installPath, sockFile, username, user, passwd ) ;
   if ( error !== null )
   {
      resultInfo[FIELD_ERRNO]  = error.getErrCode() ;
      resultInfo[FIELD_DETAIL] = getErr( error.getErrCode() ) ;
   ...
   for( var index in resultInfo )
   {
      ...
      */
          ...
          8 != nodeResult[FIELD_ERRNO] )
      {
         ...
         //del inst
         args = '' ;
         args += ' delinst ' + businessName + ' --baklog --force' ;
         error = _runRemoteCmd( cmd, exec, args, timeout ) ;
         if ( error !== null )
         {
            nodeResult[FIELD_ERRNO]  = error.getErrCode() ;
