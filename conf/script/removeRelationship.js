...
function main()
{
   var PD_LOGGER = new Logger( "removeRelationship.js" ) ;

   PD_LOGGER.log( PDEVENT, "Begin to remove relationship" ) ;

   var fromBuz      = BUS_JSON[FIELD_FROM] ;
   var fromBuzInfo  = fromBuz[FIELD_INFO] ;
   var businessType = fromBuzInfo[FIELD_BUSINESS_TYPE] ;
   var importFile   = '../conf/script/removeRelationship/' + businessType + '.js' ;
   ...
   PD_LOGGER.log( PDEVENT, "Finish to remove relationship" ) ;
