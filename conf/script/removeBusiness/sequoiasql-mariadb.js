...
*******************************************************************************/
/*
@description: remove sequoiasql-mariadb business
@modify list:
...
1. Generate plan
   @parameter
      ...
      var BUS_JSON = {"TaskID":206,"Type":3,"TypeDesc":"REMOVE_BUSINESS","TaskName":"REMOVE_BUSINESS","CreateTime":{"$timestamp":"2017-10-09-19.54.16.000000"},"EndTime":{"$timestamp":"2017-10-09-19.54.16.000000"},"Status":0,"StatusDesc":"INIT","AgentHost":"ubuntu-jw-01","AgentService":"11790","Info":{"ClusterName":"myCluster1","BusinessType":"sequoiasql-mariadb","BusinessName":"myModule1","DeployMod":"","Config":[{"dbpath":"/opt/sequoiasql-mariadb/database/5432","port":"5432","shared_buffers":"128MB","log_timezone":"PRC","datestyle":"iso, ymd","timezone":"PRC","lc_messages":"zh_CN.UTF-8","lc_monetary":"zh_CN","lc_numeric":"zh_CN","lc_time":"zh_CN","default_text_search_config":"pg_catalog.simple","InstallPath":"/opt/sequoiasql-mariadb/","ClusterName":"myCluster1","HostName":"ubuntu-jw-02","IP":"192.168.3.232","Passwd":"123","SshPort":"22","User":"root"}]},"errno":0,"detail":"","Progress":0,"ResultInfo":[{"HostName":"ubuntu-jw-02","Status":0,"StatusDesc":"INIT","errno":0,"detail":"","Flow":[]}]}
   @return
      RET_JSON: the format is: {"Plan":[[{"TaskID":206,"Info":{"ClusterName":"myCluster1","BusinessType":"sequoiasql-mariadb","BusinessName":"myModule1","Config":{"dbpath":"/opt/sequoiasql-mariadb/database/5432","port":"5432","shared_buffers":"128MB","log_timezone":"PRC","datestyle":"iso, ymd","timezone":"PRC","lc_messages":"zh_CN.UTF-8","lc_monetary":"zh_CN","lc_numeric":"zh_CN","lc_time":"zh_CN","default_text_search_config":"pg_catalog.simple","InstallPath":"/opt/sequoiasql-mariadb/","ClusterName":"myCluster1","HostName":"ubuntu-jw-02","IP":"192.168.3.232","Passwd":"123","SshPort":"22","User":"root","AgentService":"11790"}},"ResultInfo":{"HostName":"ubuntu-jw-02","Status":0,"StatusDesc":"INIT","errno":0,"detail":"","Flow":[],"Progress":90}}]]}
...
function _execSql( PD_LOGGER, hostName, port, user, passwd, cmd, installPath, sql, database )
{
   var result = null ;
   ...
   PD_LOGGER.logTask( PDERROR, '------------------ ' + user ) ;

   try
   {
      result = ExecSsql3( cmd, installPath, hostName, port, user, passwd, database, sql ) ;
   }
   catch( e )
   {
...
function _checkData( PD_LOGGER, resultInfo, hostName, port, user, passwd, cmd, installPath )
{
   var dbList = null ;
   var tableList = null ;
   ...
   try
   {
      ...
      dbList = _execSql( PD_LOGGER, hostName, port, user, passwd, cmd, installPath, 'select * from information_schema.SCHEMATA' ) ;
   }
   catch( e )
   {
   ...
   for( var index in dbList )
   {
      ...
      try
      {
         ...
         tableList = _execSql( PD_LOGGER, hostName, port, user, passwd, cmd,
...
function RemoveBusiness( PD_LOGGER )
{
   ...
   if( force == false &&
       _checkData( PD_LOGGER, resultInfo, hostName, port, authUser, authPasswd, cmd, installPath ) )
   {
      return resultInfo ;
   }

   //set LD_LIBRARY_PATH
   //export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/opt/sequoiasql-mariadb/lib
